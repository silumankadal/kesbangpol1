...
(function (window, factory) {
  ...
  // http://jamesroberts.name/artikel/2010/02/22/string-functions-for-javascript-trim-to-camel-case-to-dashed-and-to-underscore/
...
(function (window, factory) {
  ...
  proto.transition = function (args) {
    ...
    if (args.from) {
      this.css(args.from);
      // force redraw. http://artikel.alexmaccaw.com/css-transitions
